    ...
    <div style={rootStyle}>
      ...
      <div style={{ padding: "22px 28px", maxWidth: 1500, margin: "0 auto" }}>
                                    ...
                                    <div style={{ background: "#fff", borderRadius: 10, border: "1px solid var(--border)", padding: "16px 18px" }}>
                                      ...
                                      {(function() {
                                        ...
                                        return <div>
                                          ...
                                          <div style={row}><span style={lbl}>Interest Rate</span><span style={Object.assign({}, val, { color: "#C08B30" })}>{inv.annualRate ? (inv.annualRate * 100).toFixed(1) + "%" : ((inv.fundingStatus === "pending" || inv.fundingStatus === "approved") && !inv.fundedDate) ? "\u2014 set on funding" : "\u2014"}</span></div>
                                          <div style={row}><span style={lbl}>Penalty Rate</span><span style={Object.assign({}, val, { color: "#C0392B" })}>{inv.penaltyRate ? (inv.penaltyRate * 100).toFixed(1) + "%" : ((inv.fundingStatus === "pending" || inv.fundingStatus === "approved") && !inv.fundedDate) ? "\u2014 set on funding" : "\u2014"}</span></div>
                                          <div style={Object.assign({}, row, { borderBottom: "2px solid #e5e7eb", marginTop: 4, marginBottom: 4, paddingBottom: 6 })}></div>
              ...
              <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", padding: "22px 26px", display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px 28px", flex: 1 }}>
                  ...
                  <div style={{ borderLeft: "3px solid #7BA0D4", paddingLeft: 12 }}>
                    <div style={{ fontSize: 9, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", marginBottom: 3 }}>{"\u23f3"} Pending Decision</div>
                    <div style={{ fontSize: 22, fontWeight: 700, fontFamily: "'JetBrains Mono',monospace", color: pendDecision > 0 ? "#7BA0D4" : "var(--muted)" }}>{pendDecision}</div>
                  </div>
                  <div style={{ borderLeft: "3px solid #9B80C4", paddingLeft: 12 }}>
                    <div style={{ fontSize: 9, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", marginBottom: 3 }}>{"\u25b6"} Pending Disbursal</div>
                    <div style={{ fontSize: 22, fontWeight: 700, fontFamily: "'JetBrains Mono',monospace", color: pendDisbursal > 0 ? "#9B80C4" : "var(--muted)" }}>{pendDisbursal}</div>
                  </div>
                  </>; })()}
                  ...
                  {supPays.map(function(ep) {
                    ...
                    return <tbody key={ep.pay.paymentId}>
                      ...
                      {isExpSA && <tr><td colSpan={6} style={{ padding: "16px 22px", borderBottom: "1px solid var(--border)", background: "#F3F5F9" }}>
                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 12 }}><thead><tr>{["Invoice", "Buyer", "Alloc Date", "Allocated"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "4px 8px", fontSize: 9, fontWeight: 700, textTransform: "uppercase", color: "var(--muted)", borderBottom: "1px solid var(--border)" }}>{h}</th>; })}</tr></thead><tbody>{ep.allocs.map(function(a, ai) { var aInv = viewData.invoices.find(function(x) { return x.id === a.invoiceId; }); var effDate = a.allocDate || ep.pay.date; var isBackdated = a.allocDate && a.allocDate !== ep.pay.date; return <tr key={ai} style={{ borderBottom: "1px solid var(--border)" }}><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: "var(--accent)" }}>{a.invoiceId}</td><td style={{ padding: "5px 8px", fontSize: 11, color: "var(--text-secondary)" }}>{aInv ? aInv.buyerName : "\u2014"}</td><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: isBackdated ? "#C08B30" : "var(--text-secondary)" }}>{fmt(effDate)}</td><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: "#2E8B57", fontWeight: 600 }}>{money(a.amount, ep.pay.currency)}</td></tr>; })}</tbody></table>
        ...
        {isS && supTab === "funding" && (function() {
          ...
          var sfmc = { padding: "9px 14px", fontSize: 12, fontFamily: "'JetBrains Mono',monospace" };

          return <div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(190px,1fr))", gap: 12, marginBottom: 14 }}>
              <StatCard label="Funding Payments" value={String(allSupFunding.length)} accent="#2B4C7E" icon={"\u25c6"} />
              <StatCard label="Total Funded" value={money(r2(totalFunding), displayCcy)} accent="#2E8B57" icon={"\u25b2"} />
              <StatCard label="Completed" value={String(completedFunding.length)} accent="#2E8B57" icon={"\u2713"} />
              <StatCard label="Pending" value={String(pendingFunding.length)} accent="#C08B30" icon={"\u23f3"} />
            </div>
            <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", overflow: "hidden" }}>
              ...
              {supFunding.length > 0 && <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead><tr>{["Queue ID", "Invoice", "Amount", "CCY", "Program", "Bank", "Account", "Status", "Executed"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "8px 14px", fontSize: 9.5, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", borderBottom: "1px solid var(--border)" }}>{h}</th>; })}</tr></thead>
                  <tbody>{supFunding.map(function(fp) {
                    var sc = fp.status === "Completed" ? "#2E8B57" : "#C08B30";
                    return <tr key={fp.id} style={{ borderBottom: "1px solid var(--border)" }}>
                      ...
                      <td style={{ padding: "9px 14px", fontSize: 12, color: "var(--muted)" }}>{fp.currency}</td>
                      <td style={{ padding: "9px 14px", fontSize: 12, color: "var(--text-secondary)" }}>{fp.programName || "\u2014"}</td>
                      <td style={{ padding: "9px 14px", fontSize: 12, color: "var(--text-secondary)" }}>{fp.bankName || "\u2014"}</td>
                      <td style={Object.assign({}, sfmc, { color: "var(--text-secondary)" })}>{fp.bankDetails || "\u2014"}</td>
                      <td style={{ padding: "9px 14px" }}><span style={{ fontSize: 10.5, fontWeight: 700, textTransform: "uppercase", color: sc }}>{fp.status}</span></td>
                      <td style={{ padding: "9px 14px", fontSize: 12, color: "var(--text-secondary)" }}>{fp.executedDisplay || fp.createdDisplay || "\u2014"}</td>
                    </tr>;
                  })}</tbody>
                </table>
              </div>}
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 1200 }}>
                  ...
                  <tbody>{buyInvs.map(function(inv) {
                    ...
                    <tr style={{ borderBottom: isBuyExp ? "none" : "1px solid var(--border)", cursor: "pointer", background: isBuyExp ? "var(--card-hover)" : "transparent" }} onClick={function() { setExp(isBuyExp ? null : "buy-" + inv.id); }}>
                      ...
                      <td style={{ padding: "9px 14px" }}><button onClick={function(e) { e.stopPropagation(); setExp(isBuyExp ? null : "buy-" + inv.id); }} style={{ width: 24, height: 24, borderRadius: 6, border: "1px solid " + (isBuyExp ? "var(--accent)" : "var(--border)"), background: isBuyExp ? "var(--accent)" : "transparent", color: isBuyExp ? "#fff" : "var(--muted)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10 }}>{isBuyExp ? "\u25b4" : "\u25be"}</button></td>
                    </tr>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                        {(function() {
                          ...
                          return <div style={{ background: "#fff", borderRadius: 10, border: "1px solid var(--border)", padding: "16px 18px" }}>
                            ...
                            <div style={row}><span style={lbl}>Capital</span><span style={Object.assign({}, val, { color: "var(--accent)" })}>{money(inv.capitalDue, inv.currency)}</span></div>
                            <div style={row}><span style={lbl}>Interest Charged</span><span style={Object.assign({}, val, { color: "#C08B30" })}>{money(inv.interestCharged, inv.currency)}</span></div>
                            <div style={row}><span style={lbl}>Penalty Interest</span><span style={Object.assign({}, val, { color: inv.penaltyInterest > 0 ? "#C0392B" : "var(--muted)" })}>{inv.penaltyInterest > 0 ? money(inv.penaltyInterest, inv.currency) : "\u2014"}</span></div>
                            <div style={row}><span style={lbl}>Holdback Due</span><span style={val}>{money(inv.deferredPayment || 0, inv.currency)}</span></div>
                            ...
                            <div style={row}><span style={lbl}>Holdback O/S</span><span style={Object.assign({}, val, { color: inv.holdbackOutstanding > 0 ? "#C08B30" : "#2E8B57" })}>{money(inv.holdbackOutstanding, inv.currency)}</span></div>
                            <div style={row}><span style={lbl}>Total O/S</span><span style={Object.assign({}, val, { fontWeight: 700, color: inv.totalOutstanding > 0 ? "var(--text)" : "#2E8B57" })}>{money(inv.totalOutstanding, inv.currency)}</span></div>
                          </div>;
                        })()}
                        <div style={{ background: "#fff", borderRadius: 10, border: "1px solid var(--border)", padding: "16px 18px" }}>
                          <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", letterSpacing: "0.08em", color: "#1E3A5F", marginBottom: 10, paddingBottom: 6, borderBottom: "2px solid #1E3A5F" }}>Status & Payments</div>
        ...
        {isB && buyTab === "funding" && (function() {
          ...
          var bfmc = { padding: "9px 14px", fontSize: 12, fontFamily: "'JetBrains Mono',monospace" };

          return <div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(190px,1fr))", gap: 12, marginBottom: 14 }}>
              <StatCard label="Funding Payments" value={String(allBuyFunding.length)} accent="#2B4C7E" icon={"\u25c6"} />
              <StatCard label="Total Funded" value={money(r2(totalFunding), displayCcy)} accent="#2E8B57" icon={"\u25b2"} />
              <StatCard label="Completed" value={String(completedFunding.length)} accent="#2E8B57" icon={"\u2713"} />
              <StatCard label="Pending" value={String(pendingFunding.length)} accent="#C08B30" icon={"\u23f3"} />
            </div>
            <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", overflow: "hidden" }}>
              ...
              {allBuyFunding.length > 0 && <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead><tr>{["Queue ID", "Invoice", "Supplier", "Amount", "CCY", "Program", "Status", "Executed"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "8px 14px", fontSize: 9.5, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", borderBottom: "1px solid var(--border)" }}>{h}</th>; })}</tr></thead>
                  <tbody>{allBuyFunding.map(function(fp) {
                    ...
                    return <tr key={fp.id} style={{ borderBottom: "1px solid var(--border)" }}>
                      ...
                      <td style={{ padding: "9px 14px", fontSize: 12, color: "var(--text-secondary)" }}>{fp.supplierName}</td>
                      ...
                      {progPays.map(function(ep) {
                        ...
                        return <tbody key={ep.pay.paymentId}>
                          ...
                          {isExpPA && <tr><td colSpan={6} style={{ padding: "16px 22px", borderBottom: "1px solid var(--border)", background: "#F3F5F9" }}>
                            <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", marginBottom: 6 }}>Allocations ({ep.allocs.length})</div>
                            <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 12 }}><thead><tr>{["Invoice", "Supplier", "Buyer", "Alloc Date", "Allocated"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "4px 8px", fontSize: 9, fontWeight: 700, textTransform: "uppercase", color: "var(--muted)", borderBottom: "1px solid var(--border)" }}>{h}</th>; })}</tr></thead><tbody>{ep.allocs.map(function(a, ai) { var aInv = viewData.invoices.find(function(x) { return x.id === a.invoiceId; }); var effDate = a.allocDate || ep.pay.date; var isBackdated = a.allocDate && a.allocDate !== ep.pay.date; return <tr key={ai} style={{ borderBottom: "1px solid var(--border)" }}><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: "var(--accent)" }}>{a.invoiceId}</td><td style={{ padding: "5px 8px", fontSize: 11 }}>{aInv ? aInv.supplierName : "\u2014"}</td><td style={{ padding: "5px 8px", fontSize: 11, color: "var(--text-secondary)" }}>{aInv ? aInv.buyerName : "\u2014"}</td><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: isBackdated ? "#C08B30" : "var(--text-secondary)" }}>{fmt(effDate)}</td><td style={{ padding: "5px 8px", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", color: "#2E8B57", fontWeight: 600 }}>{money(a.amount, ep.pay.currency)}</td></tr>; })}</tbody></table>
                            {(function() { var pLogs = AUDIT_LOG.filter(function(e) { return e.context && e.context.paymentId === ep.pay.paymentId; }); if (pLogs.length === 0) return null; return <div style={{ marginBottom: 12 }}><div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", marginBottom: 6 }}>Audit Trail ({pLogs.length})</div><div style={{ maxHeight: 120, overflowY: "auto", border: "1px solid var(--border)", borderRadius: 8 }}><table style={{ width: "100%", borderCollapse: "collapse" }}><thead><tr>{["Time", "Action", "Details"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "4px 8px", fontSize: 9, fontWeight: 700, textTransform: "uppercase", color: "var(--muted)", borderBottom: "1px solid var(--border)", position: "sticky", top: 0, background: "#F3F5F9" }}>{h}</th>; })}</tr></thead><tbody>{pLogs.slice().reverse().map(function(e, ei) { return <tr key={ei} style={{ borderBottom: "1px solid var(--border)" }}><td style={{ padding: "4px 8px", fontSize: 10, fontFamily: "'JetBrains Mono',monospace", color: "var(--text-secondary)", whiteSpace: "nowrap" }}>{e.displayTime}</td><td style={{ padding: "4px 8px", fontSize: 10, fontWeight: 600, color: "var(--accent)" }}>{e.action}</td><td style={{ padding: "4px 8px", fontSize: 10, color: "var(--text-secondary)" }}>{e.details}</td></tr>; })}</tbody></table></div></div>; })()}
        ...
        {writeOffInv && <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }} onClick={function() { setWriteOffInv(null); }}>
          ...
          {isF && selectedProgram && progTab === "funding" && (function() {
            ...
            var pfmc = { padding: "9px 14px", fontSize: 12, fontFamily: "'JetBrains Mono',monospace" };

            return <div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(190px,1fr))", gap: 12, marginBottom: 14 }}>
                <StatCard label="Funding Payments" value={String(allProgFunding.length)} accent="#2B4C7E" icon={"\u25c6"} />
                <StatCard label="Total Funded" value={money(r2(totalFunding), prog.currency)} accent="#2E8B57" icon={"\u25b2"} />
                <StatCard label="Completed" value={String(completedFunding.length)} accent="#2E8B57" icon={"\u2713"} />
                <StatCard label="Pending" value={String(pendingFunding.length)} accent="#C08B30" icon={"\u23f3"} />
              </div>
              <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", overflow: "hidden" }}>
                ...
                {filteredFunding.length > 0 && <div style={{ overflowX: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    <thead><tr>{["Queue ID", "Invoice", "Supplier", "Amount", "CCY", "Bank", "Account", "Status", "Executed"].map(function(h) { return <th key={h} style={{ textAlign: "left", padding: "8px 14px", fontSize: 9.5, fontWeight: 700, textTransform: "uppercase", fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif", color: "var(--muted)", borderBottom: "1px solid var(--border)" }}>{h}</th>; })}</tr></thead>
                    <tbody>{filteredFunding.map(function(fp) {
                      ...
                      return <tr key={fp.id} style={{ borderBottom: "1px solid var(--border)" }}>
                        ...
                        <td style={{ padding: "9px 14px", fontSize: 12, fontWeight: 600 }}>{fp.supplierName}</td>
        ...
        {isP && !allocPay && <div style={{ marginTop: 22 }}>
          ...
          <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", overflow: "hidden" }}>
            <div style={{ padding: "16px 22px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                <div style={{ fontSize: 14, fontWeight: 700, fontFamily: "'Franklin Gothic Heavy','Arial Black',sans-serif" }}>Incoming Payments Database</div>
                ...
                {PAYMENTS_DB.filter(function(p) { var s = getPayStatus(p); if (payFilter !== "all" && payFilter !== s) return false; if (pdCcyFilter && p.currency !== pdCcyFilter) return false; if (pdDateFilter && p.date !== pdDateFilter) return false; if (pdSearch) { var q = pdSearch.toLowerCase(); if (p.paymentId.toLowerCase().indexOf(q) === -1 && (p.reference || "").toLowerCase().indexOf(q) === -1 && p.allocations.every(function(a) { return a.invoiceId.toLowerCase().indexOf(q) === -1; })) return false; } return true; }).sort(function(a, b) { return a.date > b.date ? -1 : 1; }).map(function(pay) {
                  ...
                  return <tbody key={pay.paymentId}>
                    ...
                    <td style={{ padding: "9px 12px" }}><div style={{ display: "flex", gap: 6 }}>
                      ...
                      {status !== "unallocated" && <button onClick={function(e) { e.stopPropagation(); unallocatePayment(pay.paymentId); }} style={{ padding: "5px 12px", borderRadius: 6, border: "1px solid #C0392B40", background: "transparent", color: "#E05A4F", fontSize: 11, fontWeight: 600, cursor: "pointer" }}>Unallocate</button>}
                    </div></td>
                  ...
                  {isPayExp && <tr><td colSpan={9} style={{ padding: "12px 22px", borderBottom: "1px solid var(--border)", background: "#EDF1F7" }}>
                ...
                {manageDetailTab === "overview" && (function() {
                  ...
                  <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--border)", padding: "28px 32px", marginBottom: 20 }}>
                    ...
                    {(det.primaryContact || det.primaryEmail || det.primaryPhone) && (function() {
                      var sigBadge = function(isSig) { return isSig ? <span style={{ marginLeft: 6, fontSize: 8, fontWeight: 700, color: "#2E8B57", background: "#2E8B5714", padding: "1px 5px", borderRadius: 3, textTransform: "uppercase" }}>Signatory</span> : null; };
                      var contacts = [
            ...
            {!manageDetail && manageTab !== "invoices" && manageTab !== "audit" && manageTab !== "queue" && manageTab !== "programs" && editing && <div style={{ background: "var(--card)", borderRadius: 14, border: "1px solid var(--accent)", padding: "28px 32px", marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  {isCh && manageEdit && <button onClick={chDisconnectEntity} style={{ padding: "5px 14px", borderRadius: 6, border: "1px solid #C0392B", background: "transparent", color: "#C0392B", fontSize: 11, fontWeight: 700, cursor: "pointer" }}>{"\u2716"} Disconnect from API</button>}
                  {!isCh && manageEdit && f.companyNumber && f.companyNumber.trim() && <button onClick={chConnectEntity} style={{ padding: "5px 14px", borderRadius: 6, border: "1px solid #2E8B57", background: "transparent", color: "#2E8B57", fontSize: 11, fontWeight: 700, cursor: "pointer" }}>{"\u2714"} Connect to API</button>}
