            ...
            <div style={{ maxHeight: 300, overflowY: "auto" }}>
              {allocViewData && (function() {
                ...
                var eligible = allocViewData.invoices.filter(function(inv) {
                  ...
                  // Zero-funded invoices (capitalDue === 0 but funded) should be eligible for allocations
                  // so payments can be tracked and returned to supplier
                  if (inv.fundingStatus !== "pending" && inv.capitalDue === 0 && inv.fundedDate) return true;
                  return inv.totalOutstanding > 0.01;
                });
